...
{
    public class BonLivraisonController : RCBenevoleController
    {
        public BonLivraisonController(RCBenevoleContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public IActionResult Filter(int CentreID, string NumBulletin, DateTime? DateDebut, DateTime? DateFin)
        {
            var query = _context.BonLivraison.AsQueryable();
            ...
            return PartialView("_BonLivraisonTable", results);
        }
